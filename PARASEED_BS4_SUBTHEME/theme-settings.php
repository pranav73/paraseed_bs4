 ...
 */
function PARASEED_BS4_SUBTHEME_form_system_theme_settings_alter(&$form, FormStateInterface $form_state, $form_id = NULL) {
  ...
  // Email logo settings to be used with paraseed email.
  $form['email_logo'] = [
    '#type'     => 'details',
    '#title'    => t('Email Logo'),
    '#open' => FALSE,
